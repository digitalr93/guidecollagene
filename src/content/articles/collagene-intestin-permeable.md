---
title: "Collagène et Intestin Perméable (Leaky Gut) : ce que dit vraiment la science"
description: "Le collagène répare-t-il l'intestin perméable ? Rôle de la glycine, muqueuse intestinale, études disponibles. Analyse factuelle d'un sujet mal compris."
category: sante
tags:
  - intestin perméable
  - leaky gut
...
imageAlt: "Alimentation saine et intestin — collagène et santé digestive"
draft: false
featured: false
faq:
  - question: "Le collagène peut-il réparer l'intestin perméable ?"
    answer: "Les données préliminaires suggèrent que la glycine (acide aminé principal du collagène) exerce des effets protecteurs sur la muqueuse intestinale. Mais les études cliniques chez l'humain restent limitées — nous ne pouvons pas affirmer que le collagène 'répare' l'intestin perméable au sens clinique."
  - question: "Pourquoi le bouillon d'os est-il recommandé pour l'intestin ?"
    answer: "Le bouillon d'os est riche en glycine, proline et glutamine — des acides aminés qui servent de substrat énergétique aux entérocytes (cellules de la paroi intestinale). Il n'existe cependant pas d'essai clinique randomisé sur le bouillon d'os et l'hyperperméabilité intestinale."
  - question: "Quelle dose de collagène pour la santé intestinale ?"
    answer: "Les études sur la glycine et l'intestin utilisent généralement des doses de 3 à 10 g/j de glycine pure ou équivalent. 10 g de collagène hydrolysé apporte environ 2,5 à 3 g de glycine."
  - question: "L'intestin perméable est-il reconnu par la médecine conventionnelle ?"
    answer: "La 'hyperperméabilité intestinale' est un phénomène documenté dans la littérature scientifique, associé à des pathologies comme la maladie cœliaque, les MICI et certaines maladies auto-immunes. En revanche, le terme 'leaky gut syndrome' comme entité diagnostique autonome n'est pas reconnu par les sociétés de gastroentérologie."
---

"Leaky gut", intestin perméable, hyperperméabilité intestinale — c'est l'un des sujets les plus récupérés par l'industrie des compléments alimentaires. Et le collagène est systématiquement présenté comme le remède. Voici ce que la science sait vraiment.
...
- Une étude de 2022 (Dougall et al.) a montré qu'une supplémentation en peptides de collagène (10 g/j, 8 semaines) réduisait les marqueurs d'inflammation intestinale dans un groupe de personnes souffrant de syndrome de l'intestin irritable — mais l'échantillon était petit (n=40) et sans groupe placebo robuste.

- Une revue systématique de 2021 sur la glycine et la perméabilité intestinale a conclu que les preuves sont "prometteuses mais insuffisantes" pour formuler des recommandations cliniques.
...
→ [Nutrimuscle Collagène Bovin](/produit/nutrimuscle-collagene-bovin) est une option bien dosée, sans additifs (code **NME_GC** pour -5%).
...
1. Consulter un gastroentérologue si vous suspectez un problème intestinal réel
2. Adopter une alimentation anti-inflammatoire (premier levier)
3. Intégrer un apport de glycine via le bouillon d'os ou un complément de collagène pur comme complément de l'approche globale
