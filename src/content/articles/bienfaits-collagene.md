...
faq:
  ...
  - question: "Le collagène aide-t-il vraiment les articulations ?"
    answer: "Les études montrent une réduction de l'inconfort articulaire, notamment avec le collagène UC-II® (type II natif, 40mg/j) et les peptides hydrolysés à haute dose. L'effet est plus modeste que pour la peau mais documenté."
  - question: "Combien de temps faut-il pour voir des résultats ?"
    answer: "La plupart des études cliniques observent des effets mesurables après 8 semaines minimum. Pour des effets optimaux, 3 à 6 mois de supplémentation continue sont recommandés."
  - question: "Le collagène hydrolysé est-il mieux absorbé que le collagène entier ?"
    answer: "Oui, l'hydrolyse enzymatique découpe les longues chaînes de collagène (300 kDa) en di- et tripeptides (< 3 kDa) qui traversent directement la paroi intestinale. Les études de biodisponibilité montrent que ces peptides atteignent la circulation sanguine en moins de 1 heure et s'accumulent dans les tissus cibles (peau, cartilage)."
  - question: "Quelle dose de collagène prendre pour des effets prouvés ?"
    answer: "Les doses validées cliniquement varient selon l'objectif : 2,5 g/jour pour la peau avec des peptides Verisol®, 10 g/jour pour les articulations et la peau avec des peptides standard, et 15 g/jour pour la synthèse tendineuse en contexte sportif. En dessous de 2,5 g, aucune étude sérieuse ne démontre d'effet."
  - question: "Le collagène peut-il réellement améliorer la densité osseuse ?"
    answer: "Les données humaines restent préliminaires mais positives. Une étude de König et al. (2018) sur 131 femmes post-ménopausées a montré une augmentation de la densité minérale osseuse de la colonne vertébrale et du col du fémur après 12 mois de peptides de collagène (5 g/j) vs placebo. Des études plus larges sont nécessaires pour confirmer ces résultats."
  - question: "Le collagène fonctionne-t-il différemment selon l'âge ?"
    answer: "Les effets sont généralement plus marqués chez les personnes de plus de 40 ans, car leur production endogène de collagène est déjà significativement diminuée. Les jeunes adultes avec une alimentation riche en protéines bénéficient moins de la supplémentation. Les études montrent les effets les plus importants sur la peau chez les 40–60 ans."
  - question: "Peut-on prendre du collagène à long terme sans risque ?"
    answer: "Les études de sécurité à long terme (jusqu'à 12 mois) ne rapportent pas d'effets indésirables significatifs aux doses recommandées. Il n'y a pas de phénomène de dépendance, ni d'inhibition de la production endogène. Certains experts suggèrent des pauses de 1 à 2 mois tous les 6 mois par précaution, sans base clinique solide."
  - question: "Collagène et vitamine C : pourquoi l'association est-elle indispensable ?"
    answer: "La vitamine C est un cofacteur obligatoire des enzymes prolyl hydroxylase et lysyl hydroxylase, qui stabilisent la triple hélice du collagène. Sans vitamine C suffisante, les fibres produites sont instables et se dégradent rapidement — c'est exactement le mécanisme du scorbut. Une dose de 75 à 500 mg de vitamine C avec la prise de collagène optimise l'utilisation des peptides absorbés."
  - question: "Le collagène est-il utile pour la santé intestinale ?"
    answer: "Les données sont préliminaires. La glycine du collagène a des propriétés anti-inflammatoires documentées sur la muqueuse intestinale dans des études animales. Quelques études humaines suggèrent un effet sur la perméabilité intestinale, mais le niveau de preuve reste insuffisant pour des recommandations fermes en 2026."
  - question: "Existe-t-il des études sur l'effet du collagène sur les muscles ?"
    answer: "Les données sur la masse musculaire sont limitées : le collagène est pauvre en acides aminés ramifiés (BCAA) essentiels à l'anabolisme musculaire, notamment la leucine. Des études montrent cependant un bénéfice sur la composition corporelle en association avec l'exercice, notamment chez les personnes âgées sarcopéniques (Zdzieblik et al., 2015)."
---
...
→ Consultez notre [guide pour choisir le bon collagène](/guide/comment-choisir) selon vos objectifs.
