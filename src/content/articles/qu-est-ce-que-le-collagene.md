...
faq:
  ...
  - question: "À partir de quel âge la production de collagène diminue-t-elle ?"
    answer: "La production de collagène commence à décliner à partir de 25 ans, à un rythme d'environ 1 à 1,5% par an. À 40 ans, la production peut avoir chuté de 15 à 20%."
  - question: "Peut-on augmenter son collagène naturellement ?"
    answer: "Oui, en consommant suffisamment de vitamine C (cofacteur essentiel de la synthèse), des acides aminés précurseurs (glycine, proline, hydroxyproline) et en limitant le tabac, l'alcool et l'exposition solaire excessive qui dégradent le collagène."
  - question: "Le bouillon d'os est-il aussi efficace que les compléments de collagène ?"
    answer: "Le bouillon d'os apporte de la gélatine (collagène partiellement hydrolysé) et des acides aminés précurseurs (glycine, proline), mais la concentration et la biodisponibilité sont très variables selon la préparation. Un bouillon d'os maison (4–8 heures de mijotage) peut apporter 3 à 5 g de protéines de collagène par tasse, sans standardisation possible. Les compléments certifiés (Peptan®, Naticol®) garantissent un poids moléculaire précis et une dose reproductible."
  - question: "Combien de types de collagène existe-t-il dans le corps humain ?"
    answer: "28 types de collagène ont été identifiés chez l'humain. Les types I, II et III représentent 80 à 90 % du collagène total. Le type IV est présent dans les membranes basales, le type V dans les fibres musculaires, le type X dans les cartilages en croissance. Pour la supplémentation, seuls les types I, II et III ont des applications cliniques documentées."
  - question: "La glycation peut-elle vraiment accélérer le vieillissement du collagène ?"
    answer: "Oui, significativement. La glycation est la réaction chimique entre le sucre et les acides aminés des fibres de collagène (réaction de Maillard biologique). Elle crée des liaisons croisées anormales (AGE — Advanced Glycation End-products) qui rigidifient et fragilisent les fibres. Un régime riche en sucres raffinés accélère le vieillissement cutané, articulaire et vasculaire. La restriction en glucides rapides est l'une des interventions alimentaires anti-âge les plus documentées."
  - question: "Le collagène qu'on mange est-il digéré complètement ou absorbé intact ?"
    answer: "Partiellement. La majorité des protéines de collagène est dégradée en acides aminés libres durant la digestion. Mais des études de traçage ont montré que certains dipeptides spécifiques (Pro-Hyp, Hyp-Gly) résistent partiellement à la digestion et atteignent la circulation sanguine intacts. Ces peptides bioactifs exercent des effets sur les fibroblastes, chondrocytes et ostéoblastes — c'est la base scientifique de la supplémentation en peptides hydrolysés."
  - question: "Le collagène joue-t-il un rôle dans la santé cardiovasculaire ?"
    answer: "Oui. Le collagène de type III est le composant principal des parois des artères. Sa dégradation avec l'âge est associée à la rigidité artérielle et à l'hypertension. Quelques études préliminaires suggèrent que les peptides de collagène peuvent améliorer l'élasticité artérielle, mais les données chez l'humain restent insuffisantes pour des recommandations fermes en prévention cardiovasculaire."
  - question: "Quelle est la différence entre collagène hydrolysé, gélatine et collagène natif ?"
    answer: "Le collagène natif est la protéine dans son état d'origine (non modifiée, triple hélice). La gélatine est obtenue par chauffage du collagène — les hélices se déroulent, donnant une protéine soluble dans l'eau chaude qui gélifie au refroidissement. Le collagène hydrolysé est de la gélatine soumise à une hydrolyse enzymatique qui la découpe en peptides courts (< 3 kDa), solubles à froid, sans propriété gélifiante. Les peptides hydrolysés ont la meilleure biodisponibilité des trois."
  - question: "Le collagène est-il présent dans les plantes ?"
    answer: "Non. Le collagène est une protéine exclusivement animale. Les plantes produisent leurs propres protéines structurelles (cellulose, lignine, extensines) qui n'ont aucune homologie avec le collagène. Les produits 'collagène végétal' sont en réalité des mélanges de cofacteurs de synthèse endogène (vitamine C, silicium, acides aminés). Ils peuvent stimuler votre production de collagène, mais n'en contiennent pas."
---

## Le collagène, la protéine structurelle de votre corps
...
→ Pour savoir lequel choisir, lisez notre [guide d'achat complet](/guide/comment-choisir).
